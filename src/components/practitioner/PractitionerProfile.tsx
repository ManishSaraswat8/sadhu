...
import { Settings, LogOut, Calendar, DollarSign, Users, TrendingUp } from "lucide-react";
...
export function PractitionerProfile() {
  ...
  const isSettingsActive = location.pathname === "/practitioner/settings";
  ...
  // Get user's name from practitioner or metadata
  const userNameRaw = practitioner?.name || 
